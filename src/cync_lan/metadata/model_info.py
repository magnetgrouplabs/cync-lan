...
class LightCapabilities:
    power: Annotated[bool, Field(default=True)]
    dimmable: Annotated[bool, Field(default=False)]
    tunable_white: Annotated[bool, Field(default=False)]
    color: Annotated[bool, Field(default=False)]
    colour: Annotated[bool, Field(default=False, alias="color")]


@dataclass
class DeviceProtocol:
    TCP: Annotated[bool, Field(default=True)]
    BTLE: Annotated[bool, Field(default=True)]
    MATTER: Annotated[bool, Field(default=False)]
